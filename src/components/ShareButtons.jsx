...
export default function ShareButtons({ title, url, text, image, mapUrl, platforms, children }) {
  const absoluteUrl = (u) => {
  ...
  const links = {
    // Facebook respects 'u' and optional 'quote'. Prefer static map image -> mapUrl -> page URL.
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(image || mapUrl || shareUrl)}&quote=${encodeURIComponent(shareText + '\n' + shareUrl)}`,
