...
export default function Admin() {
  ...
  // Material Symbols names for clarity
  const iconForSection = React.useCallback((sid) => ({
    'admin-header': 'web',
    'admin-hero': 'wallpaper',
    ...
    'admin-footer': 'border_bottom',
    'admin-newsletter': 'mail',
    'admin-share': 'ios_share',
    'admin-chat': 'chat_bubble',
    'admin-liveaction': 'live_tv',
    'admin-registration': 'how_to_reg',
    'admin-ratings': 'reviews',
    'admin-maps': 'map',
    'admin-analytics': 'insights',
    'admin-subscribers': 'group',
  }[sid] || 'radio_button_checked'), [])
